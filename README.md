...
Для группы и канала нужны числовые ID. Быстрый способ включить видимость ID: зайдите в Настройки профиля > Продвинутые настройки > Экспериментальные настройки, включите Show Peer IDs in Profile.
